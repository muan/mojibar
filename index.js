...
var mb = menubar({ dir: path.join(__dirname, 'app'), width: 440, height: 270, icon: path.join(__dirname, 'app/Icon-Template.png'), preloadWindow: true, windowPosition: 'topRight', alwaysOnTop: true })
